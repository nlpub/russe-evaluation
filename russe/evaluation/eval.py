...
def hj_evaluation(args):
    print "======================================================="
    print "Evaluation based on correlations with human judgements"
    print "See Section 1.1 of http://russe.nlpub.ru/task\n"

    print "Input file:", args.hj_fpath
    hj_df = read_csv(args.hj_fpath, ',', encoding='utf8')
    print "Spearman's correlation with human judgements:\t%.5f (p-value = %.3f)" % spearmanr(hj_df.hj, hj_df.sim)
    print "Pearson's correlation with human judgements:\t%.5f (p-value = %.3f)" % pearsonr(hj_df.hj, hj_df.sim)

    return spearmanr(hj_df.hj, hj_df.sim)[0]


def semantic_relation_classification_evaluation(args):
    print "======================================================="
...
def main():
    ...
    parser_hj.set_defaults(func=hj_evaluation)
    ...
    parser_hj.set_defaults(func=semantic_relation_classification_evaluation)
